  ...
  return (
    <section id="about" className="py-20 px-6">
      <div className="container mx-auto max-w-5xl">
        {" "}
        {/* Tăng max-w lên chút để chứa đủ 3 cột */}
        ...
        <div className="glass-card p-8 md:p-12 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pb-6 border-b border-white/5">
            ...
            {/* Email (Mới thêm vào) */}
            {/* Email (Đã sửa lỗi tràn text) */}
            <div className="flex items-center gap-4">
              <div className="p-2.5 bg-purple-500/10 rounded-lg border border-purple-500/20 flex-shrink-0">
                {" "}
                {/* Thêm flex-shrink-0 để icon không bị bóp méo */}
                <Mail className="w-5 h-5 text-purple-400" />
              </div>
              {/* Thêm min-w-0 và flex-1 vào div cha này */}
              <div className="min-w-0 flex-1">
                <p className="text-xs text-gray-500 uppercase tracking-wider font-semibold">
                  Email
                </p>
                {/* Sử dụng thẻ a, thêm class truncate và title */}
                <a
                  href="mailto:nguyenbaohuydeveloper@gmail.com"
                  title="nguyenbaohuydeveloper@gmail.com"
                  className="text-gray-200 font-medium truncate block hover:text-cyan-400 transition-colors"
                >
                  nguyenbaohuydeveloper@gmail.com
                </a>
              </div>
            </div>
          ...
          <div className="flex items-start gap-5">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-300 leading-relaxed text-lg">
                ...
                . Dedicated to building robust, scalable systems that solve
                real-world problems.
              </p>
            </div>
          </div>
